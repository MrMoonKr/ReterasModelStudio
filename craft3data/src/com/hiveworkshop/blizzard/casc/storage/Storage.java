...
public class Storage implements AutoCloseable {
    ...
    /**
     * FileChannel을 이용한 파일 입출력을 위한 룩업테이블( Lookup Table )
     */
    private final HashMap<Integer, FileChannel> channelMap = new HashMap<>();

    /**
     * ".idx" 파일 룩업배열( Lookup Array )
     */
     ...
     *
     * @param dataFolder       "설치폴더/Data" Path of the CASC data folder.
    ...
    /**
     * 파일을 메모리버퍼로 전체 로드 Loads a file fully into memory. Memory mapping is used if
     * allowed.
     *

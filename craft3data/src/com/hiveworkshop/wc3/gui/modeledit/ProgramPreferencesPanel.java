...
public final class ProgramPreferencesPanel extends JTabbedPane {
    ...
    public ProgramPreferencesPanel( final ProgramPreferences programPreferences,
        ...
        generalPrefsPanel.add( new JLabel( "Always use minimal Matrices in HD (the \"4.5\" save format):" ),
                "cell 0 10" );
        ...
        cameraSpinBox.addActionListener( new ActionListener() {
            ...
            public void actionPerformed( final ActionEvent e ) {
                programPreferences
                        .setThreeDCameraSpinButton( ( MouseButtonPreference )cameraSpinBox.getSelectedItem() );
            }
        } );
        ...
        this.dataSourceChooserPanel = new DataSourceChooserPanel( dataSources );
        this.addTab( "Warcraft Data", this.dataSourceChooserPanel );
    }

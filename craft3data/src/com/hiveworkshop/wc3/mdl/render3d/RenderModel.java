...
public final class RenderModel {
    ...
    // emitter algorithm
    private final Vector3f[] spacialVectors = { 
    ...
    public void refreshFromEditor( final AnimatedRenderEnvironment animatedRenderEnvironment,
            final ViewerCamera viewerCamera, 
            final RenderResourceAllocator renderResourceAllocator ) 
    {
            ...
            if ( nodeVisible ) {
                ...
                if ( objectVisible ) {
                    ...
                    if ( particles ) {
                        ...
                        if ( renderer != null ) {
                            if ( ( modelView == null )
                                    || modelView.getEditableIdObjects().contains( ( IdObject )idObject ) ) {
                                renderer.fill();
                            }
                        }

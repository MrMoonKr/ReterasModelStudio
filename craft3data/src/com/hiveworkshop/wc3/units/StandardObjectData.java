...
public class StandardObjectData {
    ...
    /**
     * "Doodads\\Doodads.slk" 및 "Doodads\\DoodadSkins.txt" 데이터 로딩
     * 
     * @return
     */
    ...
    /**
     * "Doodads\\DoodadMetaData.slk" 데이터 로딩
     * 
     * @return
     */
        ...
        public BufferedImage getImage() {
            ...
            if ( ( storedImage == null ) || ( storedImagePath == null ) || !storedImagePath.equals( artField ) ) {
                try {
                    ...
                    if ( storedImage == null ) {
                        return IconUtils.scale( BLPHandler.get()
                                .getGameTex( "ReplaceableTextures\\WorldEditUI\\DoodadPlaceholder.blp" ), 64, 64 );
                    }
                    return storedImage;

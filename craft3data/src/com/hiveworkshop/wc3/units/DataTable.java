...
public class DataTable implements ObjectData {
    ...
    /**
     * "Doodads/Doodads.slk" 및 "Doodads/DoodadsSkins.txt" 읽어 데이터 생성
     * @return
     */
    ...
    /**
     * "Units\\DestructableData.slk" 및 "Units\\DestructableSkin.txt" 파일을 읽어들여서 데이터를 생성한다.
     */
    ...
    /**
     * "Doodads/Doodads.slk" 및 "Doodads/DoodadsSkins.txt" 파일을 읽어들여서 데이터를 생성한다.
     */
    ...
    /**
     * "Units\\ItemData.slk" 및 "Units\\ItemFunc.txt", "Units\\ItemStrings.txt" 파일을 읽어들여서 데이터를 생성한다.
     */
    ...
    public void readSLK( final InputStream txt ) throws IOException {
        ...
        String input = "";
        Element currentUnit = null;
        input = reader.readLine(); // "ID;PWXL;N;E"
        if ( !input.contains( "ID" ) ) {
            System.err.println( "Formatting of SLK is unusual." );
        }
        input = reader.readLine(); // "B;X32;Y865;D0"

...
public class FaceEffectsChunk {
    ...
    public void load( final BlizzardDataInputStream in ) throws IOException {
        ...
        int chunkDataRamaining = chunkSize;
        while ( chunkDataRamaining >= 340 ) {
    ...
    public int getSize() {
        ...
        for ( final FaceEffect faceEffect : faceEffects ) {
            a += 80;
            a += 260;
            System.out.println( "FaceEffect: " + faceEffect.faceEffectTarget + " " + faceEffect.faceEffect );
        }
        return a;
    }

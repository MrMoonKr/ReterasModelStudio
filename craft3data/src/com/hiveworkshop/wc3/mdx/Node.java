...
public class Node {
    ...
    public static enum NodeFlag {
        ...
        SORT_PRIMS_FAR_Z( "SortPrimsFarZ", 0x10000 ), LINE_EMITTER( "LineEmitter", 0x20000 ),
        UNFOGGED( "Unfogged", 0x40000 ), MODEL_SPACE( "ModelSpace", 0x80000 ), XY_QUAD( "XYQuad", 0x100000 );
